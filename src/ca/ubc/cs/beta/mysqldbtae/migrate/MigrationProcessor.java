...
//private static Logger log = LoggerFactory.getLogger(MigrationProcessor.class);
	...
	public void sourceView(String source) throws SQLException
	{
		...
		while(rs.next())
		{
			...
			AlgorithmExecutionConfig execConfig = new AlgorithmExecutionConfig(rs.getString(1), rs.getString(2), configSpace, rs.getBoolean(4), rs.getBoolean(5), rs.getDouble(6));
