...
public class MySQLDBTAECutoffIdleTester {
	...
	public static void beforeClass()
	{
		...
		for(int i=0; i < 5; i++)
		{
			...
			{
				AlgorithmRunConfiguration rc = new AlgorithmRunConfiguration(new ProblemInstanceSeedPair(new ProblemInstance("TestInstance"), Long.valueOf(config.get("seed"))), 600, config,execConfig);
				runConfigs.add(rc);
			}
		}
